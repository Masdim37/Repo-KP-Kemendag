...
<head>
    ...
    <title>Password Berhasil Diperbarui | Sistem Informasi Penelitian RKA-K/L</title>
    ...
    <main class="recovery-shell">
        ...
        <section class="brand-panel" aria-label="Informasi pemulihan akun">
            ...
            <div class="brand-content">
                ...
                <h1 class="brand-title">Pemulihan selesai. <span>Akses akun siap digunakan kembali.</span></h1>
                <p class="brand-description">Kata sandi baru telah disimpan. Proses pemulihan selesai dan pengguna dapat
                    kembali masuk ke workspace penelitian RKA-K/L.</p>
                ...
                <div class="workflow">
                    ...
                    <div class="workflow-track">
                        ...
                        <div class="workflow-step is-done">
                            <div class="workflow-number"><i class="bi bi-check-lg"></i></div>
                            <strong>Password</strong><span>Buat kata sandi</span>
                        </div>
                ...
                <section class="recovery-card" aria-labelledby="recoveryTitle">
                    <div class="card-head">
                        <div class="card-heading">
                            <div class="card-icon" aria-hidden="true"><i class="bi bi-check-circle"></i></div>
                            <div>
                                <div class="card-eyebrow">Langkah 4 dari 4</div>
                                <h2 class="card-title" id="recoveryTitle">Pemulihan Akun Selesai</h2>
                            </div>
                        </div>
                        <p class="card-description">Seluruh tahapan verifikasi telah berhasil diselesaikan.</p>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="success-hero">
                            ...
                            <h3 class="success-title">Kata Sandi Berhasil Diperbarui</h3>
                            <p class="success-description">Pemulihan akses akun telah selesai. Gunakan kata sandi baru
                                Anda untuk masuk kembali ke Sistem Informasi Penelitian RKA-K/L.</p>
                        </div>
                        <div class="tips-box">
                            <div class="tips-title"><i class="bi bi-shield-check"></i>Keamanan Kredensial</div>
                            <ul class="tips-list">
                                <li>Jangan membagikan kata sandi maupun kode OTP kepada pihak lain.</li>
                                <li>Gunakan kata sandi yang tidak digunakan pada layanan atau akun lainnya.</li>
                                <li>Jika terdapat aktivitas akun yang tidak dikenali, segera lakukan pengamanan
                                    kredensial.</li>
                            </ul>
                        </div>
                        <a href="{{ route('login') }}" class="primary-button"><i
                                class="bi bi-box-arrow-in-right"></i>Kembali ke Halaman Login</a>
